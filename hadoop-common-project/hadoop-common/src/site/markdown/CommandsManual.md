...
Example:
    ...
    $ bin/hadoop daemonlog -setlevel 127.0.0.1:9870 com.gmail.benrcarver.serverlessnamenode.hdfs.server.namenode.NameNode DEBUG
    $ bin/hadoop daemonlog -getlevel 127.0.0.1:9871 com.gmail.benrcarver.serverlessnamenode.hdfs.server.namenode.NameNode DEBUG -protocol https
