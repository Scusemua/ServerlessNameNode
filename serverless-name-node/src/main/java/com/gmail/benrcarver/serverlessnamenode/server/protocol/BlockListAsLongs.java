...
import com.gmail.benrcarver.serverlessnamenode.server.datanode.Replica;
...
public abstract class BlockListAsLongs implements Iterable<BlockListAsLongs.BlockReportReplica> {
            ...
            return new Iterator<BlockReportReplica>() {
                ...
                public BlockReportReplica next() {
                    ...
                    try {
                        ...
                        block.setState(HdfsServerConstants.ReplicaState.getState((int)state));
                    } catch (IOException e) {
