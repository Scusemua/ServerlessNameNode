...
public abstract class ByteArrayManager {
  static final Log LOG = LogFactory.getLog(com.gmail.benrcarver.serverlessnamenode.hdfs.util.ByteArrayManager.class);
  ...
  static class CounterMap {
    /** @see com.gmail.benrcarver.serverlessnamenode.hdfs.util.ByteArrayManager.Conf#countResetTimePeriodMs */
    private final long countResetTimePeriodMs;
   ...
   * via the {@link com.gmail.benrcarver.serverlessnamenode.hdfs.util.ByteArrayManager#release(byte[])} method.
   *
   ...
   * by the {@link com.gmail.benrcarver.serverlessnamenode.hdfs.util.ByteArrayManager#newByteArray(int)} method.
   * 
   * @return the number of free array.
   */
  public abstract int release(byte[] array);

  public static com.gmail.benrcarver.serverlessnamenode.hdfs.util.ByteArrayManager newInstance(Conf conf) {
   ...
   */
  static class NewByteArrayWithoutLimit extends com.gmail.benrcarver.serverlessnamenode.hdfs.util.ByteArrayManager {
    @Override
   ...
   * array objects.
   */
  static class Impl extends com.gmail.benrcarver.serverlessnamenode.hdfs.util.ByteArrayManager {
