...
public class BlockReaderFactory implements ShortCircuitReplicaCreator {
  static final Log LOG = LogFactory.getLog(org.apache.hadoop.hdfs.BlockReaderFactory.class);
  ...
  public org.apache.hadoop.hdfs.BlockReaderFactory setFileName(String fileName) {
    this.fileName = fileName;
    return this;
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setEmulateHdfsClient(Boolean emulateHdfsClient){
    this.emulateHdfsClient = emulateHdfsClient;
    return this;
  }
  
  public org.apache.hadoop.hdfs.BlockReaderFactory setLocatedBlock(LocatedBlock locatedBlock) {
    this.locatedBlock = locatedBlock;
    return setExtendedBlock(locatedBlock.getBlock());
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setExtendedBlock(ExtendedBlock block) {
    this.block = block;
    return this;
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setBlockToken(Token<BlockTokenIdentifier> token) {
    this.token = token;
    return this;
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setStartOffset(long startOffset) {
    this.startOffset = startOffset;
    return this;
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setVerifyChecksum(boolean verifyChecksum) {
    this.verifyChecksum = verifyChecksum;
    return this;
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setClientName(String clientName) {
    this.clientName = clientName;
    return this;
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setDatanodeInfo(DatanodeInfo datanode) {
    this.datanode = datanode;
    return this;
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setAllowShortCircuitLocalReads(
      boolean allowShortCircuitLocalReads) {
    this.allowShortCircuitLocalReads = allowShortCircuitLocalReads;
    return this;
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setClientCacheContext(
      ClientContext clientContext) {
    this.clientContext = clientContext;
    return this;
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setLength(long length) {
    this.length = length;
    return this;
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setCachingStrategy(
      CachingStrategy cachingStrategy) {
    this.cachingStrategy = cachingStrategy;
    return this;
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setInetSocketAddress (
      InetSocketAddress inetSocketAddress) {
    this.inetSocketAddress = inetSocketAddress;
    return this;
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setUserGroupInformation(
      UserGroupInformation userGroupInformation) {
    this.userGroupInformation = userGroupInformation;
    return this;
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setRemotePeerFactory(
      RemotePeerFactory remotePeerFactory) {
    this.remotePeerFactory = remotePeerFactory;
    return this;
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setConfiguration(
      Configuration configuration) {
    this.configuration = configuration;
    return this;
  }

  public org.apache.hadoop.hdfs.BlockReaderFactory setTracer(Tracer tracer) {
    this.tracer = tracer;
    return this;
  }
   ...
   */
  public org.apache.hadoop.hdfs.BlockReader build() throws IOException {
    org.apache.hadoop.hdfs.BlockReader reader = null;
    ...
    if (locatedBlock!=null && locatedBlock.isPhantomBlock() && !emulateHdfsClient) {
      ...
      return new org.apache.hadoop.hdfs.BlockReaderDB(locatedBlock.getData(), (int) startOffset); //small file. we can safely cast long to int
    }
  ...
  /**
   * Get {@link org.apache.hadoop.hdfs.BlockReaderLocalLegacy} for short circuited local reads.
   * This block reader implements the path-based style of local reads
   * first introduced in HDFS-2246.
   */
  private org.apache.hadoop.hdfs.BlockReader getLegacyBlockReaderLocal() throws IOException {
    if (LOG.isTraceEnabled()) {
    ...
    try {
      return org.apache.hadoop.hdfs.BlockReaderLocalLegacy.newBlockReader(conf,
  ...
  private org.apache.hadoop.hdfs.BlockReader getBlockReaderLocal() throws InvalidToken {
    if (LOG.isTraceEnabled()) {
    ...
    return new org.apache.hadoop.hdfs.BlockReaderLocal.Builder(conf.getShortCircuitConf()).
   ...
   */
  private org.apache.hadoop.hdfs.BlockReader getRemoteBlockReaderFromDomain() throws IOException {
    if (pathInfo == null) {
      pathInfo = clientContext.getDomainSocketFactory()
          .getPathInfo(inetSocketAddress, conf.getShortCircuitConf());
    }
    ...
    while (true) {
      ...
      if (curPeer.fromCache) remainingCacheTries--;
      DomainPeer peer = (DomainPeer)curPeer.peer;
      org.apache.hadoop.hdfs.BlockReader blockReader = null;
      try {
   ...
   *             If there was another problem.
   */
  private org.apache.hadoop.hdfs.BlockReader getRemoteBlockReaderFromTcp() throws IOException {
    if (LOG.isTraceEnabled()) {
  ...
  private org.apache.hadoop.hdfs.BlockReader getRemoteBlockReader(Peer peer) throws IOException {
