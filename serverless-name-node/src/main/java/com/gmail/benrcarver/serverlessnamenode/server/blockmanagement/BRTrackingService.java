...
public class BRTrackingService {
  ...
  public static final Log LOG = LogFactory.getLog(com.gmail.benrcarver.serverlessnamenode.server.blockmanagement.BRTrackingService.class);
    ...
    return (ActiveNode) new LightWeightRequestHandler(HDFSOperationType.BR_LB_GET_ALL) {
      ...
      public Object performTask() throws IOException {
        ...
        try {
          ...
          LOG.info(msg);
          throw new com.gmail.benrcarver.serverlessnamenode.server.blockmanagement.BRLoadBalancingOverloadException(msg);
        } finally {
          if (!isActive) {
            connector.commit();
          }
