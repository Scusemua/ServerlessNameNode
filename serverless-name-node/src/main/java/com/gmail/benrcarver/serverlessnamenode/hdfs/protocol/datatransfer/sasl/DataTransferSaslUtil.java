...
import com.gmail.benrcarver.serverlessnamenode.protocol.DataTransferProtos;
import com.gmail.benrcarver.serverlessnamenode.protocol.DataTransferProtos.DataTransferEncryptorMessageProto;
...
public final class DataTransferSaslUtil {
    ...
    public static void sendGenericSaslErrorMessage(OutputStream out,
        ...
        sendSaslMessage(out, DataTransferProtos.DataTransferEncryptorMessageProto.DataTransferEncryptorStatus.ERROR, null, message);
    }
    ...
    public static void sendSaslMessageAndNegotiationCipherOptions(
            ...
            throws IOException {
        DataTransferProtos.DataTransferEncryptorMessageProto.Builder builder =
                DataTransferProtos.DataTransferEncryptorMessageProto.newBuilder();
    ...
    readSaslMessageAndNegotiatedCipherOption(InputStream in)
            throws IOException {
        DataTransferProtos.DataTransferEncryptorMessageProto proto =
                DataTransferProtos.DataTransferEncryptorMessageProto.parseFrom(vintPrefixed(in));
        ...
        } else if (proto.getStatus() == DataTransferProtos.DataTransferEncryptorMessageProto.DataTransferEncryptorStatus.ERROR) {
