...
public class HdfsUtils {
  private static final Log LOG = LogFactory.getLog(com.gmail.benrcarver.serverlessnamenode.hdfs.client.HdfsUtils.class);
  ...
  public static boolean isHealthy(URI uri) {
    ...
    try {
      ...
      final boolean safemode = fs.setSafeMode(HdfsConstants.SafeModeAction.SAFEMODE_GET);
