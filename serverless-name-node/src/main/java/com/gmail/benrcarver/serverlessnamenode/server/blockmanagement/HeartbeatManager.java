...
import com.gmail.benrcarver.serverlessnamenode.server.namenode.Namesystem;
 ...
 */
class HeartbeatManager implements com.gmail.benrcarver.serverlessnamenode.server.blockmanagement.DatanodeStatistics {
  static final Logger LOG = LoggerFactory.getLogger(com.gmail.benrcarver.serverlessnamenode.server.blockmanagement.HeartbeatManager.class);
  ...
  void heartbeatCheck() throws IOException {
    final com.gmail.benrcarver.serverlessnamenode.server.blockmanagement.DatanodeManager dm = blockManager.getDatanodeManager();
      ...
      while (namesystem.isRunning()) {
        try {
          ...
          if (blockManager.shouldUpdateBlockKey(now -
            ...
            synchronized (com.gmail.benrcarver.serverlessnamenode.server.blockmanagement.HeartbeatManager.this) {
              for (DatanodeDescriptor d : datanodes) {
