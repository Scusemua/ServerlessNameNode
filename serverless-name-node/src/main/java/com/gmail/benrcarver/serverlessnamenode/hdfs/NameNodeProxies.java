...
public class NameNodeProxies {
     ...
     * @param nameNodeUri the URI pointing either to a specific ServerlessNameNode
    ...
    public static <T> ProxyAndInfo<T> createNonHAProxy(
        ...
        if (xface == ClientProtocol.class) {
            ...
            String message = "Unsupported protocol found when creating the proxy " +
                    "connection to ServerlessNameNode: " +
    ...
    public static <T> FailoverProxyProvider<T> createFailoverProxyProvider(
        ...
        Preconditions.checkArgument(
                ...
                "Interface %s is not a ServerlessNameNode protocol", xface);
        try {
