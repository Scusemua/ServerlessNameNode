...
class InvalidateBlocks {
  ...
  private static final Log LOG = LogFactory.getLog(com.gmail.benrcarver.serverlessnamenode.server.blockmanagement.InvalidateBlocks.class);;
  ...
  public Map<DatanodeInfo, List<Integer>> getDatanodes(com.gmail.benrcarver.serverlessnamenode.server.blockmanagement.DatanodeManager manager)
      throws IOException {
