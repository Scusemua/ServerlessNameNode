 ...
 * {@link org.apache.hadoop.hdfs.protocolPB.DatanodeProtocolPB}.
 */
...
public class DatanodeProtocolClientSideTranslatorPB
   ...
   */
  private final org.apache.hadoop.hdfs.protocolPB.DatanodeProtocolPB rpcProxy;
  private static final VersionRequestProto VOID_VERSION_REQUEST =
      VersionRequestProto.newBuilder().build();
  private final static RpcController NULL_CONTROLLER = null;
  
  @VisibleForTesting
  public DatanodeProtocolClientSideTranslatorPB(org.apache.hadoop.hdfs.protocolPB.DatanodeProtocolPB rpcProxy) {
    this.rpcProxy = rpcProxy;
  }

  public DatanodeProtocolClientSideTranslatorPB(InetSocketAddress nameNodeAddr,
                                                Configuration conf) throws IOException {
    RPC.setProtocolEngine(conf, org.apache.hadoop.hdfs.protocolPB.DatanodeProtocolPB.class,
        ProtobufRpcEngine.class);
    UserGroupInformation ugi = UserGroupInformation.getCurrentUser();
    rpcProxy = createNamenode(nameNodeAddr, conf, ugi);
  }

  private static org.apache.hadoop.hdfs.protocolPB.DatanodeProtocolPB createNamenode(
          InetSocketAddress nameNodeAddr, Configuration conf,
          UserGroupInformation ugi) throws IOException {
    return RPC.getProtocolProxy(org.apache.hadoop.hdfs.protocolPB.DatanodeProtocolPB.class,
        RPC.getProtocolVersion(org.apache.hadoop.hdfs.protocolPB.DatanodeProtocolPB.class), nameNodeAddr, ugi,
        conf, NetUtils.getSocketFactory(conf, org.apache.hadoop.hdfs.protocolPB.DatanodeProtocolPB.class),
  ...
  public boolean isMethodSupported(String methodName) throws IOException {
    return RpcClientUtil.isMethodSupported(rpcProxy, org.apache.hadoop.hdfs.protocolPB.DatanodeProtocolPB.class,
        RPC.RpcKind.RPC_PROTOCOL_BUFFER,
        RPC.getProtocolVersion(org.apache.hadoop.hdfs.protocolPB.DatanodeProtocolPB.class), methodName);
  }
