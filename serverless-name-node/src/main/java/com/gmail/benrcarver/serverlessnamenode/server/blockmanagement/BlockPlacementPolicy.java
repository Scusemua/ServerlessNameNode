...
public abstract class BlockPlacementPolicy {
  static final Log LOG = LogFactory.getLog(com.gmail.benrcarver.serverlessnamenode.server.blockmanagement.BlockPlacementPolicy.class);
   ...
   */
  abstract public com.gmail.benrcarver.serverlessnamenode.server.blockmanagement.BlockPlacementStatus verifyBlockPlacement(String srcPath,
                                                                                                          LocatedBlock lBlk,
                                                                                                          int numOfReplicas);
  /**
   ...
   */
  public static com.gmail.benrcarver.serverlessnamenode.server.blockmanagement.BlockPlacementPolicy getInstance(Configuration conf,
    ...
    final Class<? extends BlockPlacementPolicy> replicatorClass = conf.getClass(
        ...
        com.gmail.benrcarver.serverlessnamenode.server.blockmanagement.BlockPlacementPolicy.class);
    final com.gmail.benrcarver.serverlessnamenode.server.blockmanagement.BlockPlacementPolicy replicator = ReflectionUtils.newInstance(
