 ...
 * performance. <br>
 * {@link org.apache.hadoop.hdfs.BlockReaderLocal} works as follows:
 * <ul>
...
class BlockReaderLocal implements org.apache.hadoop.hdfs.BlockReader {
  static final Log LOG = LogFactory.getLog(org.apache.hadoop.hdfs.BlockReaderLocal.class);
  ...
  public static class Builder {
    ...
    public org.apache.hadoop.hdfs.BlockReaderLocal build() {
      Preconditions.checkNotNull(replica);
      return new org.apache.hadoop.hdfs.BlockReaderLocal(this);
    }
  }
