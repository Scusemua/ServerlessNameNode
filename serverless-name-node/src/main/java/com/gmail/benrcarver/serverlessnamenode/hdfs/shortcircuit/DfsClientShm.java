...
public class DfsClientShm extends ShortCircuitShm
   ...
   * DataNode.
   *
   * {@link com.gmail.benrcarver.serverlessnamenode.hdfs.shortcircuit.DfsClientShm#handle} sets this to true.
   */
  private boolean disconnected = false;

  DfsClientShm(ShmId shmId, FileInputStream stream, DfsClientShmManager.EndpointShmManager manager,
