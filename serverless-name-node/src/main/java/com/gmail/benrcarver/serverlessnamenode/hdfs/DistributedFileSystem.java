...
public class DistributedFileSystem extends FileSystem {
     ...
     *          status
     * @see com.gmail.benrcarver.serverlessnamenode.hdfs.protocol.ClientProtocol#setSafeMode(HdfsConstants.SafeModeAction, boolean)
     */
    public boolean setSafeMode(HdfsConstants.SafeModeAction action,
     ...
     * @see com.gmail.benrcarver.serverlessnamenode.hdfs.protocol.ClientProtocol#setQuota(String, long, long, StorageType)
     */
