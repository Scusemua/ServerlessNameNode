...
class BlockPK {
  ...
  static class ReplicaPK extends BlockPK {
    ...
    static List<ReplicaPK> getKeys(long[] blockIds, int storageId) {
      List<ReplicaPK> keys = new ArrayList<>(blockIds.length);
  ...
  static class CachedBlockPK extends BlockPK {
    ...
    static List<CachedBlockPK> getKeys(long[] blockIds, int storageId) {
      List<CachedBlockPK> keys = new ArrayList<>(blockIds.length);
      for (long blockId : blockIds) {
    ...
    static List<CachedBlockPK> getKeys(long[] inodeIds) {
      List<CachedBlockPK> keys = new ArrayList<>(inodeIds.length);
      for (long inodeId : inodeIds) {
