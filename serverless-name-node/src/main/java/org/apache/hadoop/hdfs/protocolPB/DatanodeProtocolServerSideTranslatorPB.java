...
public class DatanodeProtocolServerSideTranslatorPB
  ...
  public BlockReportResponseProto blockReport(RpcController controller,
    ...
    for (StorageBlockReportProto s : request.getReportsList()) {
      BlockReportProto report = s.getReport();
  ...
  @Override
  public BlockReportCompletedResponseProto blockReportCompleted(RpcController controller,
      BlockReportCompletedRequestProto request) throws ServiceException {
    try {
      ...
      BlockReportCompletedResponseProto.Builder response
          = BlockReportCompletedResponseProto.newBuilder();
  ...
  @Override
  public SmallFileDataResponseProto getSmallFileData(RpcController controller,
      GetSmallFileDataProto request) throws ServiceException {
    try {
