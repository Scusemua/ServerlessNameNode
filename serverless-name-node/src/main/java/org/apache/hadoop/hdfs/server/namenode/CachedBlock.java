...
import com.gmail.benrcarver.serverlessnamenode.hdfs.server.blockmanagement.DatanodeDescriptor;
import com.gmail.benrcarver.serverlessnamenode.hdfs.server.blockmanagement.DatanodeManager;
    ...
    static public Collection<CachedBlock> toHops(Collection<io.hops.metadata.hdfs.entity.CachedBlock> dbBlocks,
        ...
        for (io.hops.metadata.hdfs.entity.CachedBlock dalBlock : dbBlocks) {
            ...
            if (block == null) {
                ...
                if(!Type.valueOf(dalBlock.getStatus()).equals(Type.INIT)){
                ...
                result.put(dalBlock.getBlockId(), new CachedBlock(dalBlock.getBlockId(), dalBlock.getInodeId(), dalBlock.
                        getReplicationAndMark(), Type.valueOf(dalBlock.getStatus()), datanode));
            } else if(!Type.valueOf(dalBlock.getStatus()).equals(Type.INIT)) {
