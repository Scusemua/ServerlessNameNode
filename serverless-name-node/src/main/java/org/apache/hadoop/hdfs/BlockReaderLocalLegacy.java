 ...
 *
 * {@link org.apache.hadoop.hdfs.BlockReaderLocalLegacy} works as follows:
 * <ul>
...
class BlockReaderLocalLegacy implements org.apache.hadoop.hdfs.BlockReader {
  private static final Log LOG = LogFactory.getLog(org.apache.hadoop.hdfs.BlockReaderLocalLegacy.class);
   ...
   */
  static org.apache.hadoop.hdfs.BlockReaderLocalLegacy newBlockReader(DfsClientConf conf,
    ...
    org.apache.hadoop.hdfs.BlockReaderLocalLegacy localBlockReader = null;
    ...
    try {
      ...
      if (!skipChecksumCheck) {
        ...
        localBlockReader = new org.apache.hadoop.hdfs.BlockReaderLocalLegacy(scConf, file, blk, token,
