...
/**
 * A CachePool describes a set of cache resources being managed by the ServerlessNameNode.
 * User caching requests are billed to the cache pool specified in the request.
 *
 * This is an internal class, only used on the ServerlessNameNode.  For identifying or
