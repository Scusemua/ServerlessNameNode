...
import com.gmail.benrcarver.ServerlessMDS.Exceptions.ExitException;
import com.gmail.benrcarver.ServerlessMDS.Exceptions.HadoopIllegalArgumentException;
import com.gmail.benrcarver.ServerlessMDS.Exceptions.ServiceFailedException;

import com.gmail.benrcarver.ServerlessMDS.Protocol.Constants;
import com.gmail.benrcarver.ServerlessMDS.Protocol.DFSConfigKeys;
import com.gmail.benrcarver.ServerlessMDS.Protocol.HdfsServerConstants.StartupOption;

import static com.gmail.benrcarver.ServerlessMDS.Protocol.HdfsServerConstants.RollingUpgradeStartupOption;

import com.gmail.benrcarver.ServerlessMDS.Common.StorageInfo;
...
//            }
    ...
    private void startActiveServicesInternal() throws IOException, ExitException {
        try {
